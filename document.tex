...
\subsection{Choice of \texttt{MaxEpoch}}
...
In particular, testing the network $5$ times, with an optimal initial learning rate of $0.001$ and $8$ epochs, collecting the accuracy of each run and averaging the results returned the following Table,
