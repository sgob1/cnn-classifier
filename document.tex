...
Individual contribution and net improvement of each of these methods is not investigated \--- what is provided, instead, is a description of the implementation for each technique along with the necessary details, and a final overview of all improvements altogether with respect to the baseline. 

\subsection{Data augmentation}

The first improvement of the network
