...
with the same options as the baseline, but \texttt{MaxEpoch} set to $11$ (this kind of training resulted to be slower), returned a validation accuracy of around $\sim 38\%$. Hence, the added complexity represented an improvement from the previous step. 
